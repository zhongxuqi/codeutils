<template>
  <div class="scratch-paper">
    ...
    <p>感谢您使用草稿本，您在使用我们的服务时，我们可能会收集和使用您的相关信息。
    ...
    如对本《隐私政策》或相关事宜有任何问题，请通过easypass.inc@gmail.com与我们联系。</p>

    <h2>基本信息</h2>
    <p style="color: red">APP名称：草稿本<br/>开发者：杭州探艺科技有限公司</p>
    ...
    <p>此处仅为权限相关说明，我们将在您使用特定产品功能时，向您申请使用该功能所必须的权限，如您不同意开启该权限，请点击“不允许”，拒绝该权限的申请仅将影响您对特定产品功能的使用。我们在此向您列举产品将可能收集的权限类型及其使用目的。
      ...
      <br/><b>存储权限</b>，读写本地存储着用户在使用本软件时产生的记录文件。
    </p>

    <h2>第三方SDK清单</h2>
    <p>
      <b>第三方SDK名称: </b>友盟SDK<br/>
      <b>收集使用的个人信息</b>: 授权信息、设备信息（如IMEI/IMSI、SIM卡序列号/MAC地址、android_id）、网络信息以及地理位置信息。<br/>
      <b>使用目的</b>: 根据用户的使用偏好优化APP，提供更好的用户体验。
    </p>
    <p>
      <b>第三方SDK名称</b>: 腾讯开放平台SDK<br/>
      <b>收集使用的个人信息</b>: 授权信息。<br/>
      <b>使用目的</b>: 用于QQ登录。
    </p>
    <p>
      <b>第三方SDK名称</b>: 微博SDK<br/>
      <b>收集使用的个人信息</b>: 授权信息。<br/>
      <b>使用目的</b>: 用于微博登录。
    </p>
    ...
    <h2>注销账号</h2>
    <p>
      您可以通过APP设置功能注销您在平台的账号。具体路径为：<b>左上角按钮打开菜单->点击侧边栏用户信息旁边的注销按钮</b>，注销账号后我们将停止为您提供对应的服务。
    </p>
