<template>
  <div class="easy-compressor">
    <h2 style="text-align:center">《Easy解压缩用户隐私协议》</h2>
    <p>尊敬的用户：</p>
    <p>Easy解压缩应用是由杭州探艺科技有限公司（以下简称“探艺公司”）为您提供的一款智能语音服务产品。探艺公司十分尊重您的个人信息和数据，并会尽全力保护您的个人信息和数据的安全可靠。本政策仅适用于Easy解压缩应用收集和存储的用户信息和数据。</p>
