<template>
  ...
  <p>杭州探艺科技科技有限公司（以下可统称为“我们”）高度重视个人信息的保护，您在使用我们的服务时，我们可能会收集和使用您的相关信息。
    ...
    如对本《隐私政策》或相关事宜有任何问题，请通过tensorart@126.com与我们联系。</p>
  ...
  <h2>我们获取的您的信息</h2>
  <p>第三方SDK使用个人信息的目的、方式和范围：
    <br />
    <br /><b>阿里设备标识SDK（com.ta.utdid2）：</b>
    <br />用于生成设备唯一标识符ID。标识符ID用于支付宝支付。
    <br />
    <br /><b>获取的个人信息字段：</b>Android ID和IMSI。
    <br /><b>数据保护方式：</b>采用SSL协议加密及HTTPS传输加密技术保障安全，采取加密、去标识化等安全措施脱敏处理。
    <br /><b>各类信息的具体用途如下：</b>
    <br /><b>设备或软件信息</b>。用户点击同意协议后，我们会采集用户的设备ID和IMSI。
  </p>
  ...
  <p>除以下情形外，未经您同意，我们不会与任何第三方分享您的个人信息：
    <br/>我们可能将您的个人信息与第三方服务供应商、承包商及代理（例如代表我们发出电子邮件或
    通知的通讯服务提供商、为我们提供位置数据的地图服务供应商）分享（他们可能并非位于您所在的法域），用作下列用途：
    <br/>向您提供我们的服务；
  ...
  <p>注销操作是不可恢复的操作。同时，账号注销后，您将无法再登录相应账号使用相关服务，除我们按照相关法律规定应该保留的相关信息、权益或其他数据外，在您注销账号项下存储、使用等的全部信息、数据等将会被永久删除，请您谨慎进行账号注销操作。
    <br/>此外，账号注销并不代表您在该账号注销前的所有账号行为和相关责任得到豁免或减损。如果您还有尚未使用的权益，注销申请将视为您主动放弃相应权益。
    <br /><b>注销方式和处理时效</b>，我们不在软件中设置账号注销的功能，如您需要注销，在完全理解注销可能产生的后果的前提下，发送邮件到客户服务邮箱tensorart@126.com，主题“账号注销”，并提供账号信息和相关的身份证明资料，我们会在7个工作日内完成注销操作。发送邮件申请账号注销，即视为您完全理解并同意本条目所述内容。
  </p>

  <h2>权限申请及应用场景</h2>
  <p>此处仅为权限相关说明，我们将在您使用特定产品功能时，向您申请使用该功能所必须的权限，如您不同意开启该权限，请点击“不允许”，拒绝该权限的申请仅将影响您对特定产品功能的使用。我们在此向您列举产品将可能收集的权限类型及其使用目的。
    <br /><b>网络访问权限</b>，访问网络信息，用于下载本产品运行需要的必要文件，例如资源文件包和用户在使用本软件时产生文件在服务器上的备份。
    <br /><b>存储权限</b>，读写本地存储着红用户在使用本软件时产生的记录文件。
    <br /><b>相册读取权限</b>，读取用户本地存储的图片，用于用户添加滤镜、画框等编辑操作。
    <br /><b>拍照权限</b>，拍摄照片，获得的照片用于用户添加滤镜、画框等编辑操作。
    <br /><b>通知权限</b>，向用户发送通知，例如平台活动、营销信息等。
  </p>

  <h2>版权信息</h2>

  <p>杭州探艺科技有限公司 版权所有 Copyright © 2020-2021 TensorArt. All Rights Reserved.</p>

  <p>更新日期：2022年12月20日</p>
  </div>
</template>
